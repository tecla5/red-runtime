...
module.exports = class Runtime {
    ...
    constructor(userSettings, adminApi) {
        userSettings.version = getVersion();
        log.init(userSettings);
        settings.init(userSettings);
        this.nodeApp = express();

        this.adminApi = adminApi || defaults.adminApi;

        redNodes.init(runtime);

        this.runtimeMetricInterval = null;
        this.started = false;
        // version
        // reinstallAttempts;
        // reinstallTimeout;
            ...
            .then(function () {
                ...
                return redNodes.load().then(function () {
                    ...
                    if (settings.httpStatic) {
                        log.info(log._('runtime.paths.httpStatic', {
                            path: path.resolve(settings.httpStatic)
                        }));
                    }
