...
module.exports = class LocalFileSystem {
    ...
    getModuleFiles(module) {
        ...
        if (moduleFiles.length === 0) {
            var err = new Error(log._('nodes.registry.localfilesystem.module-not-found', {
                module: module
            }));
    ...
    scanDirForNodesModules(dir, moduleName) {
        var results = [];
        try {
     ...
     */
    scanTreeForNodesModules(moduleName) {
