...
describe('runtime', function () {
    ...
    describe('start', function () {
        ...
        beforeEach(function () {
            storageInit = sinon.stub(storage, 'init', function (settings) {
                return when.resolve();
            });
            logMetric = sinon.stub(log, 'metric', function () {
                return false;
            });
            ...
            redNodesLoad = sinon.stub(redNodes, 'load', function () {
                return when.resolve()
            });
        ...
        it('initiates load of missing modules', function (done) {
            ...
            var serverInstallModule = sinon.stub(redNodes, 'installModule', function (name) {
                return when.resolve({
                    nodes: []
                });
            });
