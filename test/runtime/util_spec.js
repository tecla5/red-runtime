...
describe('red/util', function () {
    ...
    describe('evaluateNodeProperty', function () {
        ...
        it('returns evaluated json', function () {
            var result = util.evaluateNodeProperty('{'
                a ':123}', 'json');
            result.should.eql({
                a: 123
            });
...
describe('normaliseNodeTypeName', function () {
    ...
    it('pass blank', function () {
        normalise('', '')
    });
    it('pass ab1', function () {
        normalise('ab1', 'ab1')
    });
    it('pass AB1', function () {
        normalise('AB1', 'aB1')
    });
    it('pass a b 1', function () {
        normalise('a b 1', 'aB1')
    });
    it('pass a-b-1', function () {
        normalise('a-b-1', 'aB1')
    ...
    it('pass _a_b_1_', function () {
        normalise('_a_b_1_', 'aB1')
    });
    it('pass http request', function () {
        normalise('http request', 'httpRequest')
    });
    it('pass HttpRequest', function () {
...
it('accesses flow context from an expression', function () {
    var expr = util.prepareJSONataExpression('$flowContext('
        foo ')', {
            context: function () {
                return {
                    flow: {
...
it('handles non-existant global context variable', function () {
    var expr = util.prepareJSONataExpression('$globalContext('
        nonExistant ')', {
            context: function () {
                return {
                    global: {
