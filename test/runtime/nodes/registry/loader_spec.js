...
var registry = require('../../../../src/runtime/nodes/registry/registry');

var nodes = require('../../../../src/runtime/nodes/registry');
...
describe('red/nodes/registry/loader', function () {
    ...
    describe('#load', function () {
        it('load empty set without settings available', function (done) {
            ...
            stubs.push(sinon.stub(registry, 'saveNodeList', function () {
                return {};
            }));
            loader.init({
                nodes: nodes,
        ...
        it('load core node files scanned by lfs - single node single file', function (done) {
            ...
            stubs.push(sinon.stub(registry, 'addNodeSet', function () {
                return
            }));
            // This module isn't already loaded
            stubs.push(sinon.stub(registry, 'getNodeInfo', function () {
                return null;
            }));
    ...
    describe('#addModule', function () {
        ...
        it('returns rejected error if module already loaded', function (done) {
            stubs.push(sinon.stub(registry, 'getModuleInfo', function () {
                return {}
            }));
            loader.init({
                nodes: nodes,
