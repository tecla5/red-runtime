...
describe('Flow', function () {
    ...
    describe('#handleStatus', function () {
            ...
            it('passes a status event to the adjacent status node in subflow', function (done) {
                ...
                flow.handleStatus(activeNodes[sfInstanceId], {
                    text: 'my-status'
                });
            ...
            it('passes a status event to the subflow'
                s parent tab status node ', function (done) {
                var config = flowUtils.parseConfig([{
                        id: 't1',
                        type: 'tab'
                    },
                ...
                getNode.restore(); getNode = sinon.stub(flows, 'get', function (id) {
                    return flow.getNode(id);
                });
                ...
                statusMessage.should.have.a.property('status'); statusMessage.status.should.have.a.property('text', 'my-status'); statusMessage.status.should.have.a.property('source'); statusMessage.status.source.should.have.a.property('id', sfInstanceId); statusMessage.status.source.should.have.a.property('type', 'test2'); statusMessage.status.source.should.have.a.property('name', undefined);
...
describe('#handleError', function () {
        ...
        it('passes an error event to the adjacent catch node in subflow', function (done) {
            ...
            flow.handleError(activeNodes[sfInstanceId], 'my-error', {
                a: 'foo'
            });
        ...
        it('passes an error event to the subflow'
            s parent tab
            catch node ', function (done) {
            var config = flowUtils.parseConfig([{
                    id: 't1',
                    type: 'tab'
                },
            ...
            statusMessage.should.have.a.property('error'); statusMessage.error.should.have.a.property('message', 'my-error'); statusMessage.error.should.have.a.property('source'); statusMessage.error.source.should.have.a.property('id', sfInstanceId); statusMessage.error.source.should.have.a.property('type', 'test2'); statusMessage.error.source.should.have.a.property('name', undefined);
